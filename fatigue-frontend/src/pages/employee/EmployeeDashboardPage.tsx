...
export function EmployeeDashboardPage() {
  ...
  return (
    <div className="space-y-8">
      ...
      {myFatigueLevel > 70 && (
        <div className="bg-yellow-50 border-l-4 border-yellow-500 p-6 rounded-lg flex items-start gap-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 flex flex-col justify-between">
          <div className="flex items-center justify-between mb-2">
            <span className="text-gray-600 text-sm font-semibold">Nivel de Riesgo</span>
            <svg width="20" height="20" fill="none" viewBox="0 0 24 24" stroke={myRiskLevel === 'Alto' ? '#DC2626' : myRiskLevel === 'Medio' ? '#F59E0B' : '#22C55E'}>
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 flex flex-col justify-between">
          <div className="flex items-center justify-between mb-2">
            <span className="text-gray-600 text-sm font-semibold">Alertas Activas</span>
            <svg width="20" height="20" fill="none" viewBox="0 0 24 24" stroke={stats.pending_alerts > 0 ? '#F59E0B' : '#22C55E'}>
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6.002 6.002 0 00-4-5.659V5a2 2 0 10-4 0v.341C7.67 6.165 6 8.388 6 11v3.159c0 .538-.214 1.055-.595 1.436L4 17h5m6 0v1a3 3 0 11-6 0v-1m6 0H9" />
            </svg>
          </div>
          <div className="flex items-end gap-2">
            <span className="text-3xl font-bold text-[#18314F]">{stats.pending_alerts}</span>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
          <div className="flex items-center gap-2 mb-4">
            <svg width="20" height="20" fill="none" viewBox="0 0 24 24" stroke="#18314F">
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
          <div className="flex justify-between items-center mb-6">
            <div className="flex items-center gap-2">
              ...
              <span className="text-lg font-semibold text-[#18314F]">Recomendaciones Personalizadas</span>
            </div>
      ...
      <div className="bg-white rounded-lg shadow-sm border border-gray-200 px-8 py-6">
        <h2 className="text-lg font-semibold text-[#18314F] mb-6">Acciones Rápidas</h2>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <button 
            onClick={() => setIsReportSymptomModalOpen(true)}
            className="flex items-center justify-center gap-2 bg-[#18314F] hover:bg-[#18314F]/90 text-white font-semibold py-3 px-6 rounded-lg transition-colors"
          >
